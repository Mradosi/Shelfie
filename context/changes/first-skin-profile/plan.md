...
- [ ] 2.1 Moduł questionnaire i jego integracja z route'ami przechodzą lint bez błędów
- [ ] 2.2 Produkcyjny build przechodzi z nowym wizardem i payload mappingiem

#### Manual

- [ ] 2.3 Wizard działa jako 3 kroki z poprawnym stanem progresu, walidacją i nawigacją wstecz
- [ ] 2.4 Odpowiedzi obserwowalne zapisują się jako poprawne `skin_aspects` w istniejącym kontrakcie
- [ ] 2.5 Suggested chips i własne wpisy dla `concerns`/`goals` kończą jako oczekiwane wartości w persisted `string[]`
